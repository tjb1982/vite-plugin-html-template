...
const cleanId = (str)=>str.substring(0, str.length - postfix.length);
const srcToTemplate = (src)=>`const template = document.createElement("template");
